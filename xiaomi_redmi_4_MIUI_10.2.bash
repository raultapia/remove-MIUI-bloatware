...
### This file is used for removing bloatware in Xiaomi Redmi 4 with MIUI Global 10.2 Stable
### No root necessary
...
### WARNING: Removing some packages may crash the device if you have upgraded from MIUI 9.5
